...
export default function AdminAnalyticsPage() {
  return (
    <ProtectedRoute requireAdmin={true}>
      <AdminLayout title="Analytics" subtitle="View system analytics and reports">
        <div className="bg-white rounded-lg shadow p-8">
          <div className="text-center">
            <ChartBarIcon className="mx-auto h-12 w-12 text-gray-400" />
            <h3 className="mt-2 text-sm font-medium text-gray-900">Analytics Dashboard</h3>
            <p className="mt-1 text-sm text-gray-500">
              This section will provide insights into system usage, performance metrics, and user analytics.
            </p>
            <div className="mt-6">
