...
export default function AdminSettingsPage() {
  return (
    <ProtectedRoute requireAdmin={true}>
      <AdminLayout title="Settings" subtitle="System configuration and preferences">
        <div className="bg-white rounded-lg shadow p-8">
          <div className="text-center">
            <CogIcon className="mx-auto h-12 w-12 text-gray-400" />
            <h3 className="mt-2 text-sm font-medium text-gray-900">System Settings</h3>
            <p className="mt-1 text-sm text-gray-500">
              This section will allow you to configure system settings, preferences, and application parameters.
            </p>
            <div className="mt-6">
